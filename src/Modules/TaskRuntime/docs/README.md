...
See [Tasks and Daemons](../../../Framework/docs/architecture/tasks-and-daemons.md) for the shared task model. Skeleton repositories can include TaskSamples-style example handlers to show task payload and handler composition end to end.
