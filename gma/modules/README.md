...
This folder contains reusable GMA module repositories mounted as Git submodules. In GitHub, open module documentation through the owning source repository instead of a deep skeleton path under `gma/modules/...`.

| Module | Source repository docs |
| --- | --- |
| AccessControl | [AccessControl docs](https://github.com/SadPossum/GMA-Module-Access-Control/blob/dev/docs/README.md) |
